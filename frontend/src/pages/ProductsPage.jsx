...
import { 
  Search, X, SlidersHorizontal, ArrowUpDown, Sparkles, Leaf, Droplets, 
  ShieldCheck, Package, ShoppingCart, Plus, Minus, Star, ChevronLeft, ChevronRight 
} from 'lucide-react';
...
export default function ProductsPage({ onAuthOpen, onCheckout }) {
  ...
  const [sortBy, setSortBy] = useState('featured'); // 'featured' | 'price-asc' | 'price-desc' | 'rating' | 'name'
  ...
  return (
    <div className="products-page-root">
      <Helmet>
        <title>All Products — Venthulir Pure Organic Harvest</title>
        <meta 
          name="description" 
          content="Explore all cold-pressed oils, stone-ground spice powders, and native staples from Tamil Nadu heritage farms." 
        />
      </Helmet>
